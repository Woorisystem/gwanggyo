...
public class LocationActivity extends AppCompatActivity {
    ...
    private void LocationCheck(ParkingResult parkingResult)
    {
        ...
        {
            case "P1":
                locationImageView_W.setImageResource(R.drawable.p1);
                break;

            case "P2_E":
                locationImageView_W.setImageResource(R.drawable.p2);
                break;

            case "P2_W":
                locationImageView_W.setImageResource(R.drawable.p5);
                break;

            case "P3_G":
                locationImageView_W.setImageResource(R.drawable.p3);
                break;

            case "P3_B":
                locationImageView_W.setImageResource(R.drawable.p4);
                break;
