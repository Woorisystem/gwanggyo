...
import net.woorisys.pms.jk.app.SJ_BroadCast.AppNetWork;
import net.woorisys.pms.jk.app.SJ_Domain.AccelSensor;
    ...
    public void StartWholeTimer(final Context context)
    {
        ...
        WholeTimer=new CountDownTimer(Delay,1000) {
            ...
            public void onFinish() {
                ...
                if(dataManagerSingleton.isOutParkingFlag())
                {
...
//                    }
    ...
    {
        //Log.d("TIMER","StartCollectAccelBeacon :");
    ...
    {
        //Log.d("TIMER","NotStartBeacon :");
        NotStartBeaconStart=true;

        NotStartBeaconStartTimerTask =new TimerTask() {
            @Override
            public void run() {
                //Log.d("TIMER","VALUE BEACON : "+dataManagerSingleton.getNOSTARTBEACON().size());
                dataManagerSingleton.getNOSTARTBEACON().clear();
            }
        };
    ...
    {
        Log.d("TIMER","AFTERGYROSTARTTIMER :");
    ...
    {
        Log.d("TIMER","AFTERLOBBYELETIMER :");
