...
import net.woorisys.pms.jk.app.SJ_ETC.Item;
            ...
            switch (state) {
                case BluetoothAdapter.STATE_OFF:
                    ...
                    if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.O) {
                        ...
                        BeaconManager_W.unbind(BeaconService.this);
                    }
                    break;
                ...
                case BluetoothAdapter.STATE_ON:
                    ...
                    if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.O) {
                        ...
                        BeaconManager_W.bind(BeaconService.this);
                    }
                    break;
                case BluetoothAdapter.STATE_TURNING_ON:
                    Log.v(TAG, "Bluetooth Turning On");
                    break;
            }
